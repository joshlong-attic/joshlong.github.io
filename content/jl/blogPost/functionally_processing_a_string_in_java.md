...
My initial attempt was valiant, but _very_ complicated. I knew how to do it in a trivial Python example:
...
All of these are good ideas, but not quite what I wanted. The following example does a bit less gymnastics than my previous example, and is functional, so I suppose it's the best solution so far. I learned a lot from this example, too. 
